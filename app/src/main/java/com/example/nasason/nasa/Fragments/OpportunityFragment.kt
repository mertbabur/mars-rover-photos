...
class OpportunityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val rootView : View = inflater.inflate(R.layout.fragment_opportunity, container, false)

        defineAttributes(rootView)
        ToolbarSet.defineToolbar(activity, rootView.toolbarForOpportunity)
        setHasOptionsMenu(true)

        getArgumentsForCameraType()

        getPhotoFromApi(Const.OPPORTUNITY, 0)
        loadMorePhotoFromApi(Const.OPPORTUNITY)
    ...
    fun defineAttributes(rootView: View){
        recyclerView = rootView.recyclerViewForOpportunity
        progressBar = rootView.progressBarForOpportunity
        scrollView = rootView.nestedScrollViewForOpportunity
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        inflater.inflate(R.menu.menu_for_toolbar_opportunity,menu)
    }
